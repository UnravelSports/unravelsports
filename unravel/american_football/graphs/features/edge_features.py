...
from ....utils import normalize_distance, normalize_sincos, non_zeros, reindex


def compute_edge_features(adjacency_matrix, p, s, a, o, dir, settings):
    ...
    dist_matrix = distances_between_players
    ...
    e_tuple = list(
        [
            ...
            reindex(acc_diff_matrix, non_zero_idxs, len_a),
