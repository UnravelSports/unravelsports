...
def compute_node_features_pl(
    ...
    feature_func_map = {
        ...
        "dist_to_goal": {
            ...
            "defaults": {
                "value": np.linalg.norm(position - goal_mouth_position, axis=1)
            },
        },
        "normed_dist_to_goal": {
        ...
        "vec_to_goal": {
            "func": lambda value: value,
            "defaults": {"value": goal_mouth_position - position},
        },
        "angle_to_goal": {
            "func": lambda value: value,
            "defaults": {
        ...
        "vec_to_ball": {
            "func": lambda value: value,
            "defaults": {"value": ball_position - position},
        },
        "angle_to_ball": {
            "func": lambda value: value,
            "defaults": {
        ...
        "is_ball": {
            "func": lambda value: value,
            "defaults": {"value": np.where(team == ball_id, 1, 0)},
        },
